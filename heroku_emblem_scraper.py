...
"""
Changed to not work on production environment;

Commented out 266, 308, 330, those are lines to update the heroku_database
heroku_key token to gain authorization to upload to the database has been deleted.
A copy of this script with heroku_emblem_characters.json file will be ran elsewhere on a crontab to keep the heroku database updated.

"""


heroku_key = "eb58c877ed2a20d492f76c277d3b7382ca0ec640"
local_key = "e4f2558a0794b8e6cdc65325c5c48a9425622e59"
headers = {'Authorization': f'Token {heroku_key}'}

PAGE_URL = "https://fehpass.fire-emblem-heroes.com/en-US/"
BASE_URL = "https://fehpass.fire-emblem-heroes.com"
FIRE_EMBLEM_FILENAME = "heroku_emblem_characters.json"
        ...
        for char_in_db in scraped_data[-5:]:
            if char_in_db['ref_id'] == latest_archived_unit_ref['ref_id'] and char_in_db['game_origin'] == "":
                ...
                with open(FILE_PATH, 'w') as json_file:
                    ...
                    #postRequest(UPDATE_CHARA_DETAILS_URL,char_details,headers)
